...
export default function SimpleMenu() {
  const onChangeSlipAmount = useChangeSlipAmount();
  const classes = useStyles();
  const [alignment, setAlignment] = React.useState<any | null>(0.1);
  ...
  const handleAlignment = (
    ...
    if (newAlignment && !isNaN(newAlignment)) {
  ...
  const handleChangeCustomAmount = (e: any) => {
    if (isCustom) {
            ...
            <ToggleContainer>
              ...
              >
                ...
                <ToggleButton value="custom" aria-label="justified">
                  <TextField id="standard-basic" onChange={(e) => handleChangeCustomAmount(e)} />
                </ToggleButton>
              </ToggleButtonGroup>
            </ToggleContainer>
