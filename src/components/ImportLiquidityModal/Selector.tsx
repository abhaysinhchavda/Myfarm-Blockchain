...
import TokenList from "../AddLiquidityModal/Sub-Compoent/Tokenlist";
import ContentLoader from "../ContentLoader";
import ManageTab from "./Managetab";
import ManageList from "../AddLiquidityModal/Sub-Compoent/Managetokenlist";
// import Switch from "@material-ui/core/Switch";
import TokenList2 from "../../constants/TokenList.json";
import { ClipLoader } from "react-spinners";
import { useFetchBalance } from "../../store/balance/hooks";
// import Balance from "../AddLiquidityModal/Balance";
...
const Selector = () => {
  ...
  const myBalancList = useFetchBalance();
  ...
  const GetValues=React.useCallback(()=>{
    console.log('tokenList_1:',tokenList)
    setTokenList(getUnique(tokenList.concat(BalanceList), "symbol"));

    console.log("test", myBalancList);
    Promise.all([
      fetch(
      ...
      .then(function (data) {
        ...
        if (data) {
          setFinalData(getUnique(FinalData.concat(data), "symbol"));
        }
      })
  ...
  },[BalanceList,FinalData,myBalancList,tokenList])
  React.useEffect(() => {
    GetValues()
